                ...
                <div class="tab-pane fade pt-3" id="profile-change-password" role="tabpanel">
                  ...
                  <form @submit.prevent="changePassword()">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="password" v-model="form._old_password" type="password" class="form-control" id="currentPassword">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="renewpassword" v-model="form.conf_password" type="password" class="form-control" id="renewPassword">
                      </div>
                    </div>
...
import axios from 'axios';
    ...
    export default{
      ...
      methods: {
        ...
        changePassword(){
            axios.put('api/changepassword/'+this.form.id).then(() => {
                toast.fire(
                'Success!',
                'Password changed!',
                'success'
