        ...
        <div class="row">
              ...
              <div class="card info-card sales-card">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" style="">
                    ...
                    <li>
                        <router-link to="/revenuelastthirty" custom v-slot="{ href, navigate, isActive }">
                        <a
                            :href="href"
                            :class="{ active: isActive }"
                            class="dropdown-item"
                ...
                <div class="card-body">
                  <h5 class="card-title">Collected Revenue <span>| Last 30 Days</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>KES. {{lastthirtydaysrevenue}}</h6>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Projected Revenue <span>| Last 30 Days</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>KES. {{lastthirtydaysprojectedrevenue}}</h6>
            ...
            <h5 class="card-title">Revenue <span>| Products sold in the last 30 days</span></h5>
            <p class="card-text">
            ...
            <!-- <a href="visitors.php" class="btn btn-primary" >Add Visitor</a> -->
                ...
                <tbody>
                    <tr  v-for="product in lastthirtydayspurchases" :key="product.id" >
...
export default({
    data(){
        return {
            ...
            lastthirtydaysprojectedrevenue: [],
            projectedpercentage: [],
            user: []
        }
    },
    ...
    methods: {
        ...
        loadLists(){
            axios.get('api/lists').then((response) => {
                ...
                this.lastthirtydaysrevenue = response.data.lists.lastthirtydaysrevenue;
                this.lastthirtydaysprojectedrevenue = response.data.lists.lastthirtydaysprojectedrevenue;
                this.projecteddifference = this.lastthirtydaysprojectedrevenue - this.lastthirtydaysrevenue;
                this.projectedpercentage = 100 * (this.projecteddifference/this.lastthirtydaysrevenue);
