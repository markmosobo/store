        ...
        <div class="row">
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Collected Revenue <span>| Last 24 Hours</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>KES. {{twentyfourhourrevenue.toLocaleString()}}</h6>
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>KES. {{twentyfourhourprojectedrevenue.toLocaleString()}}</h6>
            ...
            <h5 class="card-title">Revenue <span>| Products sold in the last 24 hrs</span></h5>
            <p class="card-text">
            ...
            <!-- <a href="visitors.php" class="btn btn-primary" >Add Visitor</a> -->
                ...
                <tbody>
                    <tr  v-for="product in twentyfourhourpurchases" :key="product.id" >
...
export default({
    data(){
        return {
            ...
            twentyfourhourrevenue: [],
            twentyfourhourprojectedrevenue: [],
            projectedpercentage: [],
            user: []
        }
    },
    ...
    methods: {
        ...
        loadLists(){
            axios.get('api/lists').then((response) => {
                ...
                this.twentyfourhourrevenue = response.data.lists.twentyfourhourrevenue;
                this.twentyfourhourprojectedrevenue = response.data.lists.twentyfourhourprojectedrevenue;
                this.projecteddifference = this.twentyfourhourprojectedrevenue - this.twentyfourhourrevenue;
                this.projectedpercentage = 100 * (this.projecteddifference/this.twentyfourhourrevenue);
