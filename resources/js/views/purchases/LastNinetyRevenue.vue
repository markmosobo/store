<template>
    <TheMaster>
        ...
        <div class="row">
              ...
              <div class="card info-card sales-card">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" style="">
                    ...
                    <li>
                        <router-link to="/revenuelastmonth" custom v-slot="{ href, navigate, isActive }">
                        <a
                            :href="href"
                            :class="{ active: isActive }"
                            class="dropdown-item"
                    ...
                    <li>
                        <router-link to="/revenuelastninety" custom v-slot="{ href, navigate, isActive }">
                        <a
                            :href="href"
                            :class="{ active: isActive }"
                            class="dropdown-item"
                ...
                <div class="card-body">
                  <h5 class="card-title">Collected Revenue <span>| Last 90 Days</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>KES. {{lastninetydaysrevenue.toLocaleString()}}</h6>
              ...
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6>KES. {{lastninetydaysprojectedrevenue.toLocaleString()}}</h6>
            ...
            <h5 class="card-title">Revenue <span>| Products sold in the last 90 days</span></h5>
            <p class="card-text">
            ...
            <!-- <a href="visitors.php" class="btn btn-primary" >Add Visitor</a> -->
                ...
                <tbody>
                    <tr  v-for="product in lastninetydayspurchases" :key="product.id" >
...
export default({
    data(){
        return {
            ...
            lastninetydaysrevenue: [],
            lastninetydaysprojectedrevenue: [],
            projectedpercentage: [],
            user: []
        }
    },
    ...
    methods: {
        ...
        loadLists(){
            axios.get('api/lists').then((response) => {
                ...
                this.lastninetydaysrevenue = response.data.lists.lastninetydaysrevenue;
                this.lastninetydaysprojectedrevenue = response.data.lists.lastninetydaysprojectedrevenue;
                this.projecteddifference = this.lastninetydaysprojectedrevenue - this.lastninetydaysrevenue;
                this.projectedpercentage = 100 * (this.projecteddifference/this.lastninetydaysrevenue);
