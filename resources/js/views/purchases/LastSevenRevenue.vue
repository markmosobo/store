        ...
        <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Projected Revenue <span>| Last 7 Days</span></h5>
            ...
            <!-- <a href="visitors.php" class="btn btn-primary" >Add Visitor</a> -->
                ...
                <tbody>
                    <tr  v-for="product in lastsevendayspurchases" :key="product.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('api/lists').then((response) => {
                ...
                this.lastsevendaysrevenue = response.data.lists.lastsevendaysrevenue;
                this.lastsevendaysprojectedrevenue = response.data.lists.lastsevendaysprojectedrevenue;
                this.projecteddifference = this.lastsevendaysrevenue - this.lastsevendaysprojectedrevenue;
                this.projectedpercentage = 100 * (this.projecteddifference/this.lastsevendaysprojectedrevenue);
