    ...
    <TheMaster>
        ...
        <div class="row">
              ...
              <div class="card info-card sales-card">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" style="">
                    ...
                    <li>
                        <router-link to="/revenuequarter" custom v-slot="{ href, navigate, isActive }">
                        <a
                            :href="href"
                            :class="{ active: isActive }"
                            class="dropdown-item"
                    ...
                    <li>
                        <router-link to="/revenuelastyear" custom v-slot="{ href, navigate, isActive }">
                        <a
                            :href="href"
                            :class="{ active: isActive }"
                            class="dropdown-item"
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      ...
                      <!--decrease-->
                      <span v-if="yearrevenue < lastyearrevenue" class="text-danger small pt-1 fw-bold">{{revenuepercentage}}%</span>
                      <span v-if="yearrevenue < lastyearrevenue" class="text-muted small pt-2 ps-1">decrease</span>
            ...
            <!-- <a href="visitors.php" class="btn btn-primary" >Add Visitor</a> -->
                ...
                <tbody>
                    <tr  v-for="product in yearpurchases" :key="product.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('api/lists').then((response) => {
                ...
                this.revenuedifference = this.yearrevenue - this.lastyearrevenue;
                this.revenuepercentage = 100 * (this.revenuedifference/this.lastyearrevenue);
                this.revenuepercentage = Number(this.revenuepercentage).toFixed(2);

                this.revenuedifference = this.yearprojectedrevenue - this.yearrevenue;
                this.projectedpercentage = 100 * (this.revenuedifference/this.yearrevenue);
