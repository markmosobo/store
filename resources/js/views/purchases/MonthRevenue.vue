        ...
        <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Collected Revenue <span>| This Month</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      ...
                      <!--decrease-->
                      <span v-if="monthrevenue < lastmonthrevenue" class="text-danger small pt-1 fw-bold">{{revenuepercentage}}%</span>
                      <span v-if="monthrevenue < lastmonthrevenue" class="text-muted small pt-2 ps-1">decrease</span>
            ...
            <h5 class="card-title">Revenue <span>| Products sold this month</span></h5>
            <p class="card-text">
            ...
            <!-- <a href="visitors.php" class="btn btn-primary" >Add Visitor</a> -->
                ...
                <tbody>
                    <tr  v-for="product in monthpurchases" :key="product.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('api/lists').then((response) => {
                ...
                this.revenuedifference = this.monthrevenue - this.lastmonthrevenue;
                this.revenuepercentage = 100 * (this.revenuedifference/this.lastmonthrevenue);
