        ...
        <div class="row">
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Collected Revenue <span>| Last Month</span></h5>
            ...
            <h5 class="card-title">Revenue <span>| Products sold last month</span></h5>
            <p class="card-text">
            ...
            <!-- <a href="visitors.php" class="btn btn-primary" >Add Visitor</a> -->
                ...
                <tbody>
                    <tr  v-for="product in lastmonthpurchases" :key="product.id" >
