    ...
    <TheMaster>
        ...
        <div class="row">
            ...
            <!-- <a href="visitors.php" class="btn btn-primary" >Add Visitor</a> -->
                ...
                <tbody>
                    <tr  v-for="product in lastyearpurchases" :key="product.id" >
    ...
    methods: {
        ...
        loadLists(){
            axios.get('api/lists').then((response) => {
                ...
                this.revenuedifference = this.lastyearprojectedrevenue - this.lastyearrevenue;
                this.projectedpercentage = 100 * (this.revenuedifference/this.lastyearrevenue);
